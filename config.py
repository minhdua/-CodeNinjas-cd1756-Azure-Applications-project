...
class Config(object):
    ...
    CLIENT_SECRET = os.getenv('CLIENT_SECRET', default='lhh8Q~IxtxqCOzQjCAv1lszlyJELFmoV.vjWza1A')
    ...
    CLIENT_ID = os.getenv('CLIENT_ID', default='22d95e6c-dc85-495e-9a0e-dcce9275323f')
